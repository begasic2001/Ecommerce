    ...
    <S.Filter>
      ...
      <S.FilterBox>
        ...
        <S.FilterItem>
          ...
          <label htmlFor="birthday-shelf" className="item__custom"></label>
          <CheckSVG />
        </S.FilterItem>
        <S.FilterItem>
          <label htmlFor="grand-opening-shelf">Kệ khai trương</label>
          <input type="checkbox" name="filter" id="grand-opening-shelf" />
          <label htmlFor="grand-opening-shelf" className="item__custom"></label>
          <CheckSVG />
        </S.FilterItem>
      </S.FilterBox>
      <S.FilterBox>
